...
const Navbar = () => {
    ...
    const navList = <>
        ...
        <li className="mr-4"><NavLink to='/allSpots'>All Tourist Spot</NavLink></li>

        {
            user && <>
                <li className="mr-4"><NavLink to='/addSpots'>Add Tourists Spot</NavLink></li>
                <li className="mr-4"><NavLink to={`/myLists/email/${user.email}`}>My Lists</NavLink></li>
            </>
        }
    </>
    ...
    return (
        <div className="navbar bg-base-100">
            <div className="navbar-start">
                ...
                <a className="btn btn-ghost text-xl text-blue-950">Tour-East</a>
            </div>
