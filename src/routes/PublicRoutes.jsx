...
const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: () => fetch("https://tourism-management-server-psi.vercel.app/allSpots")
            },
            {
                path: '/addSpots',
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`https://tourism-management-server-psi.vercel.app/allSpots/email/${params.email}`),
            },
            {
                path: '/spotDetails/:id',
                element: <PrivateRoutes> <SpotDetails></SpotDetails> </PrivateRoutes>,
                loader: ({ params }) => fetch(`https://tourism-management-server-psi.vercel.app/allSpots/${params.id}`)
            },
            {
                path: '/updateSpot/:id',
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`https://tourism-management-server-psi.vercel.app/allCountries/name/${params.name}`)
            },
